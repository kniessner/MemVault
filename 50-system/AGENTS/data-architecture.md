...
| Active projects | `30-projects/YYYY-name/` | README + decisions + log |
...
2. **Project branching:** Project-specific content stays in `30-projects/YYYY-name/`. Multi-project knowledge goes to `20-knowledge/`.
