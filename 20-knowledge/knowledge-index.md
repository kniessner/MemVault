...
for (const f of knowledgeFiles) {
  ...
  const dir = parts[0];
  if (dir === "ai-index.md" || dir === "knowledge-index.md" || dir === "README.md" || dir.startsWith("_")) continue;
  ...
  else if (f.name.endsWith("-index.md") && !rel.includes("/") && !knowledgeDirs[dir].entry) knowledgeDirs[dir].entry = f.path;
...
const totalFiles = knowledgeFiles.filter(f => !["knowledge-index.md","ai-index.md","README.md","_template.md"].includes(f.name) && !f.name.endsWith("-index.md")).length;
...
for (const c of categories) {
  ...
  const contentFiles = c.files.filter(f => !f.name.endsWith("-index.md") && !["README.md","_template.md"].includes(f.name));
...
const allContentFiles = knowledgeFiles
  .filter(f => !f.name.endsWith("-index.md") && !["README.md","_template.md"].includes(f.name))
...
lnk(linkGrid, "📦 Projects", "30-projects-active/projects-index", "font-size:0.85em;");
lnk(linkGrid, "📅 Daily Notes", "10-notes/10-daily", "font-size:0.85em;");
lnk(linkGrid, "📚 Library", "40-library/library-index", "font-size:0.85em;");
...
lnk(actionLinks, "🤖 AI", "20-knowledge/ai", "font-size:0.85em;");
lnk(actionLinks, "💼 Business", "20-knowledge/business", "font-size:0.85em;");
lnk(actionLinks, "💡 Concepts", "20-knowledge/concepts", "font-size:0.85em;");
lnk(actionLinks, "⚙️ Tech", "20-knowledge/tech", "font-size:0.85em;");
```
